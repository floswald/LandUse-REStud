...
* We provide a single driver script which will run the entire package top to bottom, after suitable software installation and configuration. This script is located at `code/run_all.sh`
* We also provide instructions to run the package step by step, i.e., executing the programs in different languages one after the other, by hand.
...
| Figure A.2   | `stata`  | `figureA2.do`            | plots/figureA2a(b).pdf                 |
...
| Figure A.20  | `R`      | `CLC_plots()`             | plots/figureA20.pdf                    |
| Figure A.21  | `R`      | `CLC_measure()`           | plots/figureA21.pdf                    |
| Figure A.22  | `R`      | `map_pra_all()`           | plots/figureA22.pdf                    |
| Figure A.23  | `R`      | `wheat_plots()`           | plots/figureA23a(b).pdf                |
| Figure A.24  | `R`      | `pra_check()`             | plots/figureA24.pdf                    |
| Figure A.25  | `R`      | `map_pra_prices2000()`    | plots/figureA25.pdf                    |
...
Executing the run script requires access to a bash shell and may not work on windows. Being able to use the run script assumes the following list of conditions:

- [ ] You installed R 4.2.2
