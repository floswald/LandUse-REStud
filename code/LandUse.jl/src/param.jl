...
function map_pkg_names_to_paper()
	...
	[
		...
		pf_sens("sigma","Lrshare_agg.pdf") => joinpath(dbplots(),"figureB11a.pdf"),
		pf_sens("sigma","pr.pdf") => joinpath(dbplots(),"figureB11b.pdf"),
		pf_sens("sigma","citydensity_1840.pdf") => joinpath(dbplots(),"figureB11c.pdf"),

		pf_sens("omega","citydensity_1840.pdf") =>      joinpath(dbplots(),"figureB12a.pdf"),
		pf_sens("omega","dr_1840.pdf") =>               joinpath(dbplots(),"figureB12b.pdf"),
		pf_sens("omega","ρr_1840.pdf") => joinpath(dbplots(),"figureB12c.pdf"),

		pf_sens("epsilonr","citydensity_1840.pdf") => joinpath(dbplots(),"figureB13a.pdf"),
		pf_sens("epsilonr","area_pop.pdf") =>          joinpath(dbplots(),"figureB13b.pdf"),
		pf_sens("epsilonr","dens_decay.pdf") =>          joinpath(dbplots(),"figureB13c.pdf"),

		pf_sens("agglomeration","congest-cityarea_agg_1840.pdf") => joinpath(dbplots(),"figureB14a.pdf"),
		pf_sens("agglomeration","congest-citydensity_1840.pdf") => joinpath(dbplots(),"figureB14b.pdf"),
		pf_sens("agglomeration","congest-d0_1840.pdf") => joinpath(dbplots(),"figureB14c.pdf"),
		pf_sens("agglomeration","congest-pr_1840.pdf") => joinpath(dbplots(),"figureB14d.pdf"),
		pf_sens("agglomeration","congest-ρr_1840.pdf") => joinpath(dbplots(),"figureB14e.pdf"),
		pf_sens("agglomeration","congest-HPI_1840.pdf") => joinpath(dbplots(),"figureB14f.pdf"),

		pf_sens("agglomeration","cityarea_agg_1840.pdf") => joinpath(dbplots(),"figureB15a.pdf"),
		pf_sens("agglomeration","citydensity_1840.pdf") =>  joinpath(dbplots(),"figureB15b.pdf"),
		pf_sens("agglomeration","d0_1840.pdf") =>           joinpath(dbplots(),"figureB15c.pdf"),
		pf_sens("agglomeration","pr_1840.pdf") =>           joinpath(dbplots(),"figureB15d.pdf"),
		pf_sens("agglomeration","ρr_1840.pdf") =>           joinpath(dbplots(),"figureB15e.pdf"),
		pf_sens("agglomeration","HPI_1840.pdf") =>          joinpath(dbplots(),"figureB15f.pdf"),

		pf_sens("d1d2","cityarea_agg_1840.pdf") => joinpath(dbplots(),"figureB16a.pdf"),
		pf_sens("d1d2","citydensity_1840.pdf") =>  joinpath(dbplots(),"figureB16b.pdf"),
		pf_sens("d1d2","d0_1840.pdf") =>           joinpath(dbplots(),"figureB16c.pdf"),
		pf_sens("d1d2","dr_1840.pdf") =>           joinpath(dbplots(),"figureB16d.pdf"),
		pf_sens("d1d2","dens_decile.pdf") =>       joinpath(dbplots(),"figureB16e.pdf"),
		pf_sens("d1d2","ρr_1840.pdf") =>           joinpath(dbplots(),"figureB16f.pdf"),

		pf_sens("d1d2","Lu_allyears_d1d2.pdf") =>   joinpath(dbplots(),"figureB17a.pdf"),
		pf_sens("d1d2","area_allyears_d1d2.pdf") => joinpath(dbplots(),"figureB17b.pdf"),
		pf_sens("d1d2","dens_allyears_d1d2.pdf") => joinpath(dbplots(),"figureB17c.pdf"),

		pf_sens("d1d2","Lu_allyears.pdf") =>   joinpath(dbplots(),"figureB18a.pdf"),
		pf_sens("d1d2","area_allyears.pdf") => joinpath(dbplots(),"figureB18b.pdf"),
		pf_sens("d1d2","dens_allyears.pdf") => joinpath(dbplots(),"figureB18c.pdf")
	]
