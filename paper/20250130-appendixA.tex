...
\begin{figure}
	\begin{center}
		\includegraphics[height=0.8\textheight]{\picsvids/recense-agr-1892.png}
...
\begin{figure}	
	...
	\begin{subfigure}{0.55\textwidth}
		%\begin{center}
			\includegraphics[width= \linewidth]{\modplots/Share_Land_Agr1840_FRA.pdf}
		%\end{center}
		\vspace{-0.65cm}
	...
	\begin{subfigure}{0.55\textwidth}
		%\begin{center}
			\includegraphics[width= \linewidth]{\modplots/Share_Emp_Agr100_FRA1806.pdf}
		%\end{center}
		\vspace{-0.65cm}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.8\textwidth]{\modplots/Price_Agri_FRA.pdf}
	\end{center}
	\vspace{-0.5cm}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.8\textwidth]{\modplots/Thetalong_FRA1840.pdf}
	\end{center}
	\vspace{-0.5cm}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{\modplots/spendingshare.pdf}
	\end{center}
	\vspace{-0.5cm}
...
\begin{figure}[p]
	\centering
	\includegraphics[height=0.45\textheight]{\screenshots/reims-EM.png}
...
\begin{figure}[p]
	\centering
	\includegraphics[height=0.45\textheight]{\screenshots/reims-1950.png}
...
\begin{figure}[p]
	\centering
	\includegraphics[height=0.45\textheight]{\screenshots/valence-EM.png}
...
\begin{figure}[p]
	\centering
	\includegraphics[height=0.45\textheight]{\screenshots/valence-1950.png}
...
\input{\datatables/france-pop-1950.tex}
\pagebreak

\input{\datatables/paris-pop-1950.tex}
...
\begin{figure}
	\centering
	\includegraphics[height=0.4\textheight]{\dataplots/GHSL-Built-Marseille-edit.pdf}
...
\begin{figure}
	\centering
	\includegraphics[height=0.45\textheight]{\dataplots/GHSL-Built-Bordeaux.pdf}
	\caption{\texttt{GHS-BUILT} raster map of Bordeaux.\label{A-fig:built-bordeaux}}
\end{figure}


\begin{figure}
	\includegraphics[width=\textwidth]{\dataplots/densities-violins.pdf}
...
\begin{figure}
	\includegraphics[width=\textwidth]{\dataplots/densities-time-top5then-city.pdf}
...
\begin{figure}[h]
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[width = \linewidth]{\dataplots/density-gradient-lyon.pdf}
		\caption{Lyon\label{A-fig:gradientlyon}}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[width = \linewidth]{\dataplots/density-gradient-lille.pdf}
...
\begin{figure}[p]
	\includegraphics[width=\textwidth]{\dataplots/densities-time-cutoff.pdf}
...
\begin{figure}[p]
	\includegraphics[width=\textwidth]{\dataplots/densities-time-wtd-cutoff.pdf}
...
\begin{figure}
	\centering
	\includegraphics[height=0.42\textheight]{\screenshots/reims-now.png}
...
\begin{figure}
	\includegraphics[width=\textwidth]{\dataplots/areas-manual-satellite.pdf}
...
\begin{figure}
	\includegraphics[width=\textwidth]{\dataplots/shlomo-paris.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.78\textwidth]{\dataplots/CLC-Reims.pdf}
...
\begin{figure}[h!]
	\includegraphics[width=\textwidth]{\dataplots/CLC-landuse-top100-agg.pdf}
...
\begin{figure}[h!]
	\begin{adjustbox}{center}
		\includegraphics[width=1.2\textwidth]{\dataplots/map-pra-all.pdf}
	\end{adjustbox}
...
\begin{figure}[h]
	\begin{adjustbox}{center}	
		\begin{subfigure}{0.6\textwidth}
			\includegraphics[width = \linewidth]{\dataplots/wheat-yield-2000.pdf}
			\caption{Wheat yields (2000).}
		\end{subfigure}
		\hspace{-1cm}
		\begin{subfigure}{0.6\textwidth}
			\includegraphics[width = \linewidth]{\dataplots/wheat-share-2000.pdf}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=0.65\textwidth]{\modplots/Screenshot-pra-paris.png}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=0.85\textwidth]{\dataplots/map-prices.pdf}
	\end{center}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=0.7\textwidth]{\modplots/mode_paris.pdf}
	\end{center}
	\vspace{-0.5cm}
...
\begin{figure}[h!]	
	...
	\begin{subfigure}{0.55\textwidth}
%	\begin{center}
	\includegraphics[width=0.93\textwidth]{\modplots/speed_paris1.pdf}
%\end{center}
\vspace{-0.1cm}
\caption{Speed across transportation modes.\label{A-fig:speed1}}
	\end{subfigure}%
	...
	\begin{subfigure}{0.55\textwidth}
%	\begin{center}
	\includegraphics[width=0.93\textwidth]{\modplots/speed_paris2.pdf}
%\end{center}
\vspace{-0.1cm}
\caption{Evolution of average speed across mode categories.\label{A-fig:speed2}}
	\end{subfigure}%
